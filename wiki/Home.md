# maczo Originals — Plinko · Provably Fair

Welcome. This wiki explains how every **Plinko** result on [maczo.co](https://maczo.co) is provably
...
- 🔐 **[The Algorithm](Algorithm)** — the HMAC-SHA256 → uint32 engine + Plinko's resolve step
...
- **Live (offline in your browser):** https://verify.maczo.co/originals/?game=plinko
- **Source / Node CLI:** https://github.com/maczo-co/originals-plinko
- **Published odds:** https://verify.maczo.co/originals/paytables/plinko.json
